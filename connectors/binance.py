...
# from networkx import balanced_tree, contracted_edge, contracted_nodes
import requests
import time
import typing
import collections
...
class BinanceClient:
    ...
    # def get_contracts(self) -> typing.Dict[str, Contract]:
        #
    def get_contracts(self) -> typing.Dict[str, contracted_edge]:
    ...
    def get_historical_candles(self, contract: Contract, interval: str) -> typing.List[HANDLE]:
        data = dict()
        ...
        if raw_candles is not None:
            for c in raw_candles:
                candles.append(Handle(c, interval, "binance"))
    ...
    def get_balances(self) -> typing.Dict[str, balanced_tree]:
        data = dict()
    ...
    def _on_open(self, ws):
        ...
        # self.subscribe_channel([], "!bookTicker")
    ...
    def subscribe_channel(self, contracts: typing.List[Contract]):
