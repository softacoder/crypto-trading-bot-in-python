...
class BinanceFuturesClient:
    def __init__(self, public_key: str, secret_key: str, testnet: bool):
        if testnet:
            self._base_url = "https://testnet.binancefutures.com"
...
def get_bid_ask(self, contract: Contract) -> typing.Dict[str, float]:
    ...
    def place_order(self, contract: Contract, side: str, quantity: float, order_type: str, price=None, tif=None) -> OrderStatus:            data = dict()
        data['symbol'] = symbol
        data['side'] = side
        ...
        order_status = self._generate_signature(data)
    ...
    def cancel_order(self, contract: Contract, order_id: int) -> OrderStatus:
        ...
        order_status = self.generate_signature(data)
